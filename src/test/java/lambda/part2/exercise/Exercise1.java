...
class Exercise1 {
    ...
    private static BiFunction<Person, Person, Integer> createExtractorAgeOfPersonWithTheLongestFullName(Function<Person, String> fullAgeExtractor) {
        BiFunction<Person, Person, Integer> personPersonIntegerBiFunction = (o, o2) -> null;
        return (p1, p2) -> fullAgeExtractor.apply(p1).length() > fullAgeExtractor.apply(p2).length()
                ? p1.getAge()
                : p2.getAge();
    }
